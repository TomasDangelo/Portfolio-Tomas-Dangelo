  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <p className='py-4 max-w-[700px] text-[#8892b0]'>Soy Licenciado en Relaciones Internacionales, pero mi pasión por el aprendizaje me llevó a iniciar mi camino como developer en 2022. Ya finalicé cursos de Desarrollo Web, Javascript y ReactJS. En este momento, estoy aprendiendo programación backend con el objetivo de convertirme en Full Stack Developer. Para 2023, voy a estudiar Ingeniería en Sistemas de la información en la Universidad Tecnológica Nacional.
            </p>
        <div>
