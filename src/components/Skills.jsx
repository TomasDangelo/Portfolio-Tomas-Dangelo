      ...
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
          <div>
              <p className='text-4xl font-bold inline border-b-4 border-pink-600'>
                {language === 'spanish'? 'Habilidades' : 'Skills'}</p>
              <p className='py-4'>{language === 'spanish'? 'Actualmente tengo conocimientos en estas tecnologías:' : 'I have knowledge in the following technologies:' }</p>
          </div>
